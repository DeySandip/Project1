...
if(isset($_POST['submit'])){
 ...
 $reportno = $_POST['reportno'];
  $damage = $_POST['damage'];
 $q = " INSERT INTO `part`(`driver_id`, `regno`, `reportNumber`, `damageAmount`) VALUES ('$driver_id',' $regno','$reportno','$damage')";
...
<head>
	...
	<li><a href="s.php">Search</a></li>
	    ...
	    <div class="login-box" style="height: 460px;">
        ...
        <h1>Add  Data</h1>
            ...
            <p>Report No.</p>
            <input type="text" name="reportno" placeholder="Enter Report No" required="">
            <p>Damage Amount</p>
            <input type="number" name="damage" placeholder="Enter Damage Amount " required="">
